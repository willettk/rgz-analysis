...
Script to reduce the data in prep for the formal launch of Radio Galaxy Zoo 
Written by Julie Banfield, CSIRO (Nov 2013)
...
for item in list(subjects.find().limit(200)):
  #print item
  #print '------------------------'
  ...
  srcid = item["metadata"]["src"]	# determine the image source id

  classfile2 = open('RGZBETA2-%s-classifications.dat' % srcid, 'w')
